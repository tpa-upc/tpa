...
public class Obj2Json {
    ...
    public static void main (String[] args) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("Application/res/sphere.obj"));
        String line = "";
        ...
        Gson gson = new Gson();
        BufferedWriter writ = new BufferedWriter(new FileWriter("Application/res/sphere.json"));
